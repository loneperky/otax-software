  ...
  return(
    ...
    <div className="hero-section1">
      ...
      <div className="hero-img">
        <img src="../src/Images/01(2).jpg" alt="" />
      </div>
 </div>  

<div className="combine-section1">
    <div className="pic-slide">
       <img src="../src/Images/02(3).jpg" alt="" />
       <div className="count-imgg">
        ...
        <img src="../src/Images/01(3).jpg" alt="" />
       </div>
      </div>
      ...
      <div className="talky-sect">
        ...
        <p className="embrace">Embrace a new era of digital success with OTAX. Our team combines cutting edge design with robust development to deliver websites that captivate and convert.</p>
...
<div className="expertise" id="services">
     <div className="specialise">
      ...
      <div className="prod">
        <Product head="Digital Marketing" talk="Growing brands online through digital channels."/>
        <Product head="Product Design" talk="Creating products that users love and businesses need."/>
        <Product head="Web Design" talk="Designing websites that are visually appealing & user-friendly."/>
        <Product head="UI/UX Design" talk="Creating user-friendly and responsive websites and web apps."/>
        <Product head="Business Strategy" talk="Developing plans to achieve business goals."/>
        <Product head="Research" talk="Gathering and analyzing data to utilize decision-making."/>
        <Product head="Web Development" talk="Building and maintaining websites and web applications."/>
        <Product head="Backend Development" talk="Building and maintaining Restful Apis."/>
        <Product head="Brand Design" talk="Creating brands that are uniwue,memorable,and meaningful."/>
      </div>
</div>
...
<div className="succeed-test">
  ...
  <div className="succeed">
      ...
      <div className="testimonial">
        <div className="test1">
            <p>I highly recommend OTAX_TECH to anyone looking for highly qualify website and customer satisfaction.</p>
            <div className="img-name">
            <img src="./src/Images/01(4).jpg" alt="" />
            <p>By Nick Mac</p>
            </div>
      ...
      <div className="testimony-hero">
        <img src="../src/Images/03(2).jpg" alt="" />
      </div>
</div>
     ...
     <div className="email-collect">
      ...
      <h1>Let's talk about your  digital <br /> agency goals</h1>
...
<h1>  OTAX TECH </h1>
<p className="our">Our altimate  goal is to provide customers with <br /> the ultimate satisfaction they deserve and giving them <br /> a nice value for their money.</p>
</div>
    <div className="quick">
    <h2>Quick links</h2>
    ...
    <li><NavLink>Become a partner</NavLink></li>
    </div>
    <div className="community">
    <h2>Documents</h2>
    <li><NavLink>Supports</NavLink></li>
    <li><NavLink>Faqs</NavLink></li>
    <li><NavLink>Privacy Policy</NavLink></li>
    <li><NavLink>Terms & condition</NavLink></li>
    </div>
    <div className="follow">
      <NavLink  ><img src="./src/Images/whatsapp.png" alt="" /></NavLink>
    <Link > <img src="./src/Images/whatsapp.png" alt="" /></Link>
